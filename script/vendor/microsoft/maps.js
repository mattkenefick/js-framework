(function() {
    ...
    var n, t;
    window.$MapsNamespace = window.$MapsNamespace || "Microsoft", window[$MapsNamespace] = window[$MapsNamespace] || {}, window[$MapsNamespace].Maps = window[$MapsNamespace].Maps || {}, n = {
        domain: "http://ecn.dev.virtualearth.net/mapcontrol/v7.0",
        version: "7.0.2014071064147.83",
        locale: "en-us",
        tilelocale: "en-us",
        ishttpsenabled: false,
        onloadcallback: "__onscriptload__",
        tilegeneration: 2732,
        tileMetaGeneration: 2727,
        odmtilegeneration: 53,
        zoomOriginWidth: 256,
        defaultTileSize: 256,
        minMercatorZoom: 1,
        maxMercatorZoom: 20,
        ...
        disableSearch: false,
        disableTasks: false,
        disableMyPlaces: false,
        myPlacesUriFormat: "http://www.bing.com/maps/GeoCommunity.aspx",
        ...
        preloadBingTheme: 0,
        venueMapsLandingPageEnabled: true,
        displayMapAppsPanel: false,
        ...
        autoSuggestServiceHostUrl: "{urischeme}platform.bing.com/geo/autosuggest/v1",
        autoSuggestServiceUrlFormat: "{host_url}?umv={user_map_view}&ul={user_location}&q={query}&reqid={jsonso}&mr={max_results}&cb={callback}",
        enableAutoSuggestEndpointUrlParam: false,
        init: function() {
            var r, u, n, f, t, i;
            for (this.protocol = this.ishttpsenabled ? "https://" : "http://", r = "onscriptload", this.onloadcallback === "__" + r + "__" && (this.onloadcallback = null), this.ishttpsenabled ? (this.onDemandDomain = "t{subdomain}.ssl.ak.dynamic.tiles.virtualearth.net", this.staticDomain = "t{subdomain}.ssl.ak.tiles.virtualearth.net") : (this.onDemandDomain = "ak.dynamic.t{subdomain}.tiles.virtualearth.net", this.staticDomain = "ak.t{subdomain}.tiles.virtualearth.net"), u = this.domain + "/" + this.version + "/css/en/", this.cssPath = u, n = this.domain + "/" + this.version + "/i/", f = this.domain + "/" + this.version + "/js/en-us/", this.jsPath = f, this.directionsImagePath = n + "Directions/", this.venueMapsEroServiceAppId = "BF17C84531C2B15EBE4BACA0F545AF4040188EFA", t = [
                ...
                ["roadUriFormat", "{urischeme}{ondemanddomain}/comp/ch/{quadkey}?mkt={tilemarket}&it=G,L&shading=hill&og={odmgeneration}&n=z&key={key}"],
                ["roadUnlabeledUriFormat", "{urischeme}{staticdomain}/tiles/r{quadkey}?g={generation}&mkt={culture}&lbl=l0&stl=h&shading=hill&n=z"],
                ["aerialUriFormat", "{urischeme}{staticdomain}/tiles/a{quadkey}.jpeg?g={generation}&n=z"],
                ["aerialWithLabelsUriFormat", "{urischeme}{ondemanddomain}/comp/ch/{quadkey}?mkt={tilemarket}&it=A,G,L&shading=hill&og={odmgeneration}&n=z&key={key}"],
                ["enhancedBirdseyeUriFormat", "{urischeme}{staticdomain}/tiles/svi{quadkey}?g={generation}&dir={dir}&n=z"],
                ["enhancedBirdseyeWithLabelsUriFormat", "{urischeme}{staticdomain}/tiles/cmd/svhybrid?a={quadkey}&g={generation}&dir={dir}&n=z"],
                ["nativeBirdseyeUriFormat", "{urischeme}{staticdomain}/tiles/o{quadkey}-{runtimeindex}-{level}-{index}?g={generation}"],
                ["nativeBirdseyeWithLabelsUriFormat", "{urischeme}{staticdomain}/tiles/cmd/ObliqueHybrid?a={quadkey}-{runtimeindex}-{level}-{index}&g={generation}"],
                ["fbUriFormat", "{urischeme}{staticdomain}/tiles/r{quadkey}?g={generation}&mkt={culture}&lbl=l1&stl=fb&shading=hill&n=z&key=AkF0mEyG789RQA6CcLimWZMzrDNF6MNSwRJOmNWb9gK_JGiwOBeMoQUoY1MFqksg"],
                ...
                ["weatherLightUriFormat", "{urischeme}ecn.dynamic.t{subdomain}.tiles.virtualearth.net/comp/ch/{quadkey}?mkt={culture}&it=GB&cstl=WL&og={odmgeneration}&n=z"],
                ["weatherDarkUriFormat", "{urischeme}ecn.dynamic.t{subdomain}.tiles.virtualearth.net/comp/ch/{quadkey}?mkt={culture}&it=GB&cstl=WD&og={odmgeneration}&n=z"],
                ["weatherLightLabelUriFormat", "{urischeme}ecn.dynamic.t{subdomain}.tiles.virtualearth.net/comp/ch/{quadkey}?mkt={culture}&it=Z,GF,L&cstl=WL&og={odmgeneration}&n=z"],
                ["weatherDarkLabelUriFormat", "{urischeme}ecn.dynamic.t{subdomain}.tiles.virtualearth.net/comp/ch/{quadkey}?mkt={culture}&it=Z,GF,L&cstl=WD&og={odmgeneration}&n=z"],
                ...
                ["venueMapsMetadataJsonpUrl", "default={urischeme}dev.virtualearth.net/REST/v1/JsonFilter/VenueMaps/data/{0}?culture={culture}&key={credentials};prod={urischeme}dev.virtualearth.net/REST/v1/JsonFilter/VenueMaps/data/{0}?culture={culture}&key={credentials};dev={urischeme}dev.virtualearth.net/REST/v1/JsonFilter/VenueMapsDev/data/{0}?culture={culture}&key={credentials};staging={urischeme}dev.virtualearth.net/REST/v1/JsonFilter/VenueMapsStaging/data/{0}?culture={culture}&key={credentials};venuemaps1={urischeme}dev.virtualearth.net/REST/v1/JsonFilter/VenueMaps1/data/{0}?culture={culture}&key={credentials};venuemaps2={urischeme}dev.virtualearth.net/REST/v1/JsonFilter/VenueMaps1/data/{0}?culture={culture}&key={credentials}"],
                ["venueMapsTileUrl", "default={urischeme}venuemaps.virtualearth.net/{0}/{1}/{{quadkey}}.png;prod={urischeme}venuemaps.virtualearth.net/{0}/{1}/{{quadkey}}.png;dev={urischeme}venuemapsdev.blob.core.windows.net/{0}/{1}/{{quadkey}}.png;staging={urischeme}venuemapsstaging.blob.core.windows.net/{0}/{1}/{{quadkey}}.png;venuemaps1={urischeme}venuemaps1.blob.core.windows.net/{0}/{1}/{{quadkey}}.png;venuemaps2={urischeme}venuemaps2.blob.core.windows.net/{0}/{1}/{{quadkey}}.png"],
                ...
                ["hotRegionsRoadUrl", "{urischeme}{ondemanddomain}/comp/ch/{quadkey}.json?mkt={culture}&it=G,VE,BX,L,LA&shading=hill&jsonp={jsonp}&jsonso={jsonso}&og={odmgeneration}"],
                ["hotRegionsAerialWithLabelsUrl", "{urischeme}{ondemanddomain}/comp/ch/{quadkey}.json?mkt={culture}&it=A,G,L,LA&shading=hill&jsonp={jsonp}&jsonso={jsonso}&og={odmgeneration}"],
                ["onDemandRoadUriFormat", "{urischeme}{ondemanddomain}/comp/ch/{quadkey}?mkt={culture}&it=G,VE,BX,L,LA&shading=hill&og={odmgeneration}&n=z"],
                ["onDemandAerialWithLabelsUriFormat", "{urischeme}{ondemanddomain}/comp/ch/{quadkey}?mkt={culture}&it=A,G,L,LA&shading=hill&og={odmgeneration}&n=z"],
                ["microPOIHotRegionsUrl", "{urischeme}{ondemanddomain}/mpoi/MicroPoi/{quadkey}.json?q={query}&filter={filter}&jsonp={jsonp}&jsonso={jsonso}&output=json"],
                ["microPOITilesUrl", "{urischeme}{ondemanddomain}/mpoi/MicroPoi/{quadkey}?q={query}&filter={filter}"],
                ...
                ["trafficUriFormat", "{urischeme}t{subdomain}-traffic.tiles.virtualearth.net/comp/ch/{quadkey}?it=Z,TF&n=z&key={key}"],
                ...
                ["bingThemeIconUrlFormat", n + "BingTheme/pins/pin_{iconStyle}{imageryStyle}{state}.png"],
                ...
                ["trafficIncidentsJs", "{urischeme}ecn.dev.virtualearth.net/REST/v1/Traffic/Incidents/{bounds}/?jsonp=microsoftMapsNetworkCallback&jsonso={jsono}&severity={sev}&key={credentials}"],
                ...
                ["streetsideCubeDataLookupUriFormat", "{urischeme}dev.virtualearth.net/mapcontrol/HumanScaleServices/GetBubbles.ashx?c={0}&n={1}&s={2}&e={3}&w={4}&jsCallback={5}&key={6}&gen={7}"],
                ["privacyStatementLink", "http://www.microsoft.com/privacystatement/{culture}/bing/default.aspx"]
            ], i = t.length; i--;) this[t[i][0]] = t[i][1].replace(/{ondemanddomain}/g, this.onDemandDomain).replace(/{staticdomain}/g, this.staticDomain).replace(/{urischeme}/g, this.protocol).replace(/{version}/g, this.version).replace(/{culture}/g, this.locale).replace(/{generation}/g, this.tilegeneration).replace(/{odmgeneration}/g, this.odmtilegeneration).replace(/{tilemarket}/g, this.tilelocale.indexOf("__") == -1 ? this.tilelocale : this.locale);
            this.defaultAerialTiltOn = !0, this.allowAerialMap = !0, this.allowBirdseye = !0, this.notileImageUrl = n + "notile.png", this.pushpinImageUrl = n + "poi_search.png", this.spacerImageUrl = n + "spacer.gif", this.microPOIImageUrl = n + "/MicroPOI/", this.venueMapsNumberOfMapTileServers = 4, this.venueMapsTileServerSubdomainsX = "0,2,4,6", this.venueMapsTileServerSubdomainsY = "1,3,5,7", this.logoBingMapsLink = "http://www.bing.com/maps/?v=2&cp={0}~{1}&lvl={2}&FORM=BMLOGO", this.logoBingSearchUrl = "http://www.bing.com/search?q={0}&FORM=BMSDK1", this.biciPID = "5901", this.cursorPath = this.domain + "/" + this.version + "/cursors/", this.imagePath = n, this.trafficMinZoom = 5, this.trafficMinIncidentsZoom = 8, this.trafficRefresh = 180000, this.trafficExpiry = 1800000, this.venueMapAction1Context = "Mall", this.venueMapAction2Context = "Airport", this.mapAppApp1ActionContext = "10330", this.mapAppApp2ActionContext = "10310"
        }
    }, n.init(), window[$MapsNamespace].Maps.Globals = n, t = n.jsPath + (typeof VEAPI_perflog == "undefined" ? "veapicore.js" : "veapicorePerf.js"), 0 ? n.coreJs = t : i()
})()